...
class AdminsUserview extends PolymerElement {
...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 <vaadin-horizontal-layout theme="spacing" style="align-self: stretch; margin-top: var(--lumo-space-m);">
  <vaadin-combo-box id="orderbox" style="margin-left: var(--lumo-space-xl);" label="OrderBy.."></vaadin-combo-box>
  <vaadin-combo-box id="ordertype" style="margin-left: var(--lumo-space-xl);" label="OrderType"></vaadin-combo-box>
 </vaadin-horizontal-layout>
 <vaadin-text-field placeholder="Search" id="filter" style="margin-left: var(--lumo-space-l); margin-bottom: var(--lumo-space-m); margin-top: var(--lumo-space-m); width: 50%;"></vaadin-text-field>
...
customElements.define(AdminsUserview.is, AdminsUserview);
