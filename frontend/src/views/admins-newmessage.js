...
class AdminsNewmessage extends PolymerElement {
...
<vaadin-vertical-layout style="width: 100%; height: 100%;">
 <vaadin-scroller style="width: 100%; height: 100%;">
  ...
  <vaadin-horizontal-layout theme="spacing" style="width: 100%;">
   <vaadin-text-field tabindex="0" has-label="" draggable="true" vaadin-dnd-layout-item="true" focused="" id="result" style="flex-grow: 1; margin-right: var(--lumo-space-xl); margin-left: var(--lumo-space-xl);"></vaadin-text-field>
  </vaadin-horizontal-layout>
...
customElements.define(AdminsNewmessage.is, AdminsNewmessage);
